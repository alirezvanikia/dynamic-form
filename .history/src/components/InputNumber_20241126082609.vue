<template>
    <div class="mb-4">
      <label :for="age" class="block text-sm font-medium text-gray-700">{{ label }}</label>
      <input :id="دشپث" type="number" :value="modelValue" @input="onInputChange" :placeholder="placeholder"
