  ...
  methods: {
    validation() {
      ...
      if (this.value === '' && this.required) {
       ...
       // نمایش مقدار `min`, `max` و `errorMessage` در کنسول برای بررسی
       console.log('Validation Rules:', validationRules); // اینجا ما مقدار فایل JSON رو چاپ میکنیم
      const { min, max, errorMessage } = validationRules;
      console.log('min:', min, 'max:', max, 'errorMessage:', errorMessage); // اینجا هم مقادیر min و max رو چک میکنیم
