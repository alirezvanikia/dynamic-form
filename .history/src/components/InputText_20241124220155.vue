<template>
  <div>
    ...
    <input :id="name" type="text" v-model="value" :placeholder="placeholder"
...
export default {
  props: {
    ...
    modelValue: { type: String, required: true },  // Model value for v-model
  ...
  methods: {
    onInputChange(event) {
      // Emit the updated value to the parent using v-model's custom event syntax
