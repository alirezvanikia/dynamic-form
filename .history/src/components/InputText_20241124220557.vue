<template>
  <div>
    ...
    <input
      :id="name"
      type="text"
      :value="modelValue" <!-- اینجا از :value استفاده می‌کنیم -->
      :placeholder="placeholder"
      :required="required"
      @input="$emit('update:modelValue', $event.target.value)" <!-- رویداد update:modelValue -->
...
export default {
  name: 'InputText',
  props: {
    modelValue: String,  // مدل ورودی
    label: String,       // عنوان فیلد
