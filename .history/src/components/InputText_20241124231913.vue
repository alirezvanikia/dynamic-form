<template>
  <div class="mb-4">
    ...
    <input 
      :id="name" 
      type="text" 
      :value="modelValue"  <!-- استفاده از :value به جای v-model -->
      @input="onInputChange" <!-- ارسال تغییرات به والد -->
...
export default {
  props: {
    ...
    modelValue: { type: String, required: true },  // دریافت modelValue از والد
