    ...
    actions: {
        ...
        async submitForm() {
            ...
            try {
                ...
                /*
                The API of this section is taken from the Jason file, but due to the lack of access to the API link, it was commented that only the type received from Jason should be displayed.
