    ...
    <div class="max-w-2xl mx-auto mt-10 p-6 bg-white shadow-md rounded-lg">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div>
                ...
                <input id="name" type="text" v-model="formData.name" placeholder="Enter your full name"
            ...
            <div>
                ...
                <input id="email" type="email" v-model="formData.email" placeholder="Enter your email address"
                    class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                    required />
            </div>
            ...
            <div>
                ...
                <input id="age" type="number" v-model="formData.age" placeholder="Enter your age"
                    class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            ...
            <div class="flex items-center">
                <input id="newsletter" type="checkbox" v-model="formData.newsletter"
