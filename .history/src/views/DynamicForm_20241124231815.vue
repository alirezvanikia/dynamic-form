<template>
    <div class="max-w-2xl mx-auto mt-10 p-6 bg-white shadow-md rounded-lg">
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
        <!-- استفاده از کامپوننت InputText -->
        <InputText
          name="name"
          label="Full Name"
          v-model="formData.name"  <!-- استفاده از v-model برای اتصال به داده‌ها -->
          placeholder="Enter your full name"
          required
        />
        <!-- دیگر ورودی‌ها را می‌توانید همینطور اضافه کنید -->
  ...
  <script>
  // وارد کردن کامپوننت InputText
  import InputText from '../components/InputText.vue';
  
  export default {
    components: {
      InputText,  // تعریف کامپوننت برای استفاده
    },
    data() {
      return {
        ...
        formData: {
          name: '',  // مقدار اولیه برای input
        },
      };
    },
    methods: {
      handleSubmit() {
        console.log('Form submitted:', this.formData);  // نمایش داده‌های فرم
      },
    },
  };
  </script>
