<template>
  ...
  export default {
    ...
    methods: {
      async loadFormData() {
        // فرض کنیم فایل json شما در مسیر public قرار دارد
        const response = await fetch('/formConfig.json');
        const data = await response.json();
        
        // داده‌ها را در formFields ذخیره می‌کنیم
        this.formFields = data.fields;
  
        // برای هر فیلد مقدار اولیه (خالی) تنظیم می‌کنیم
      ...
      handleSubmit() {
        ...
        // شما اینجا می‌توانید داده‌ها را به سرور ارسال کنید
      },
    },
  };
  </script>
