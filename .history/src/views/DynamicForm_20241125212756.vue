    ...
    <div class="max-w-2xl mx-auto mt-10 p-6 bg-white shadow-md rounded-lg">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div v-for="field in formConfig.fields" :key="field.name">
                <InputText v-if="field.type === 'text'" :name="field.namse" :label="field.label"
                ...
                <InputEmail v-if="field.type === 'email'" :name="field.namde" :label="field.label"
                    v-model="formData[field.namasdse]" :placeholder="field.placeholder" :required="field.required" />
            </div>
            <button type="submit"
